...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./hooks.server-D2Xzjep5.js'));
  let reroute;
  let transport;
  return {
    handle,
...
export { fallback as A, slot as B, sanitize_props as C, attributes as D, get as E, SvelteKitError as S, Server as a, setContext as b, attr_class as c, clsx as d, error$1 as e, escape_html as f, getDefaultExportFromCjs as g, getContext as h, store_get as i, ensure_array_like as j, attr_style as k, stringify as l, head as m, noop as n, attr as o, derived as p, await_block as q, redirect as r, splitCookiesString as s, spread_props as t, unsubscribe_stores as u, base as v, writable as w, commonjsGlobal as x, run as y, bind_props as z };
//# sourceMappingURL=index.js-BLQUvJvL.js.map
