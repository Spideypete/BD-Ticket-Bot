import { y as run, f as escape_html, o as attr, h as getContext, j as ensure_array_like, c as attr_class, z as bind_props } from './index.js-BLQUvJvL.js';
import { m as ms } from './index-C6Pf9mGj.js';
import { e as emoji } from './index-DiPg3ogy.js';
import { m as marked } from './marked.esm-DcwJ8j7Z.js';
import './state.svelte-DTwSBiNG.js';
import { R as Required } from './Required-DajgSg18.js';
import { q as questionsState } from './state2.svelte-CZg8XtUa.js';
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="The name of ticket channels"></i> <input type="text" class="input form-input" placeholder="ticket-{num}"${attr("required", !!category.id, true)}${attr("value", category.channelName)}/></label> `);
...
//# sourceMappingURL=_page.svelte-DNOp14Yb.js.map
